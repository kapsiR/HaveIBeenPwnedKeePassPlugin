...
All accounts with write access to this repository are mandated to use two-factor authentication and [signed commits].
...
[signed commits]: https://git-scm.com/book/en/v2/Git-Tools-Signing-Your-Work
